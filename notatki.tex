...
$f_n$ nie zbiegają jednostajnie do $f$, bo: \begin{equation}
    \forall_{\eps \in ]0, 1[, n \in \N} \exists_{x = \eps ^ \frac{1}{n}}: |f(x) - f_n(x)| = \eps \leq \eps.
\end{equation}
Zatem: \begin{equation}
    \forall_{\eps, n}: \sup| f(x) - f_n(x)| \leq \eps.
\end{equation}

\paragraph{Przykład 2.} Weźmy ciąg funkcji $\ciag{f}$, $f_n: \R to \R$ określonych następująco: 
\begin{equation}
    f_n  = \begin{cases}
...
\begin{twier}{Kryterium Weierestrassa}
    Niech $X$ będzie zbiorem. Roważmy ciąg funkcyjny $\ciag{f}$ i szereg funkcyjny $\ciag{g}$: \begin{equation}
        g_n(x)  = \sum_{k = 1}^{n} f_k(x) \quad (x \in X).
